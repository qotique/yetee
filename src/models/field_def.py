...
STATIC_FIELD_DEFS: list[FieldDef] = [
    ...
    FieldDef("lifetime", "Lifetime", FieldType.TEXT, width=96, align=ft.TextAlign.RIGHT),
    FieldDef("restock", "Restock", FieldType.TEXT, width=88, align=ft.TextAlign.RIGHT),
    FieldDef("min", "Min", FieldType.TEXT, width=48, align=ft.TextAlign.RIGHT),
    FieldDef("quantmin", "QuantMin", FieldType.TEXT, width=96, align=ft.TextAlign.RIGHT),
    FieldDef("quantmax", "QuantMax", FieldType.TEXT, width=96, align=ft.TextAlign.RIGHT),
