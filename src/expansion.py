    ...
    return {
        "CoreSettings.json": FileConfig(
            columns=(
                ...
                _field("ServerUpdateRateLimit", "Server Update Rate Limit", FieldType.INT, 200),
                _field(
        ...
        "GeneralSettings.json": FileConfig(
            columns=(
                _field("m_Version", "Version", FieldType.INT, 90),
                _field("DisableShootToUnlock", "Disable Shoot To Unlock", FieldType.INT, 210),
                _field("EnableGravecross", "Enable Gravecross", FieldType.INT, 180),
                _field("EnableAIGravecross", "Enable AI Gravecross", FieldType.INT, 190),
        ...
        "MissionSettings.json": FileConfig(
            columns=(
                ...
                _field("TimeBetweenMissions", "Time Between Missions", FieldType.INT, 210),
...
def _ai_settings_columns() -> tuple[FieldDef, ...]:
    return (
        ...
        _field("DamageReceivedMultiplier", "Damage Received Multiplier", FieldType.FLOAT, 220),
...
def _register_settings_schemas() -> None:
    per_file = {
        "CoreSettings.json": _settings_schema(_settings_config()["CoreSettings.json"].columns),
        "GeneralSettings.json": _settings_schema(_settings_config()["GeneralSettings.json"].columns),
        "MissionSettings.json": _settings_schema(_settings_config()["MissionSettings.json"].columns),
    }
...
def _register_market_schemas() -> None:
    ...
    register_form_folder_schema("Expansion Market", "market/categories", category_schema)
