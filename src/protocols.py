...
class IBatchPanel(Protocol):
    def show(self, header_text: str, usage_options: list[str], value_options: list[str], flag_names: list[str]) -> None: ...
    def hide(self) -> None: ...
    def build(self) -> object: ...
...
class ITableController(Protocol):
    def render(self, rows: list[RowData], filtered: list[int], page_idx: int) -> None: ...
